...
@Transactional
public class UpdateGlucoseAlertPolicyLowRiskUseCase {
    private final GlucoseAlertPolicyRepository glucoseAlertPolicyRepository;

    public void execute(Long id, Long memberId, UpdateGlucoseAlertPolicyLowRiskRequest request) {
        ...
        glucoseAlertPolicy.updateLowRiskValue(request.lowRiskValue());
