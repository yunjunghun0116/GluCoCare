...
/**
 * 혈당 경고 정책의 매우 고위험 기준값 업데이트를 담당하는 Use Case 클래스
 * <p>
 * 이 클래스는 기존 혈당 경고 정책의 매우 고위험(Very High Risk) 혈당 기준값을 업데이트하는
