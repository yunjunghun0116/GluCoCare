...
import com.glucocare.server.exception.NotFoundElementException;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private void setMemberAuthToken(HttpServletRequest request, Long memberId) {
        try {
            var member = memberRepository.findById(memberId).orElseThrow(() -> new NotFoundElementException("존재하지 않는 이용자 입니다."));
